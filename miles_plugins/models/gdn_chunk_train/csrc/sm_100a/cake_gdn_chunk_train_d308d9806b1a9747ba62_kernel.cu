...
kernel_cake_gdn_chunk_train_d308d9806b1a9747ba62(__nv_bfloat16* __restrict__ qn, __nv_bfloat16* __restrict__ kn, __nv_bfloat16* __restrict__ v_new, __nv_bfloat16* __restrict__ h, float* __restrict__ g_cs, __nv_bfloat16* __restrict__ o_out, int* __restrict__ chunk_start, int* __restrict__ chunk_len, int num_heads, int num_v_heads, float scale)
{
