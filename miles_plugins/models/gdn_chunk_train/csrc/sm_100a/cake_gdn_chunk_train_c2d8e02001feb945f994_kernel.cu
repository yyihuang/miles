...
kernel_cake_gdn_chunk_train_c2d8e02001feb945f994(__nv_bfloat16* __restrict__ kn, __nv_bfloat16* __restrict__ v, __nv_bfloat16* __restrict__ A, __nv_bfloat16* __restrict__ dw, __nv_bfloat16* __restrict__ du, float* __restrict__ g_cs, float* __restrict__ beta, __nv_bfloat16* __restrict__ dk2_out, __nv_bfloat16* __restrict__ dv_out, __nv_bfloat16* __restrict__ dbeta_out, float* __restrict__ dg2_out, int* __restrict__ chunk_start, int* __restrict__ chunk_len, int num_heads, int num_v_heads)
{
    ...
    if (lane_0 % 4 == 0) {
        ...
        if (row_a < n_valid) {
            __nv_bfloat16 _cvt_bf16_0 = __float2bfloat16(db_a);
            dbeta_out[gate_a_index] = _cvt_bf16_0;
            dg2_out[gate_a_index] = dg_a - colsum_a;
        }
        if (row_b < n_valid) {
            __nv_bfloat16 _cvt_bf16_1 = __float2bfloat16(db_b);
            dbeta_out[gate_b_index] = _cvt_bf16_1;
