...
kernel_cake_gdn_chunk_train_8e5debffef07e906f8cb(int* __restrict__ cu_seqlens, int* __restrict__ chunk_start, int* __restrict__ chunk_len, int* __restrict__ seq_chunk_start, int num_seqs, int num_chunks_max, int total_tokens)
{
